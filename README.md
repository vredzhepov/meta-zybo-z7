...
This layer provides support for Zybo Z7 development board.
...
URI: https://github.com/vredzhepov/meta-xilinx.git
branch: zybo-z7-zynq7
```
...
BBLAYERS ?= " \
  /mnt/ssd2/poky/meta \
  /mnt/ssd2/poky/meta-poky \
  /mnt/ssd2/poky/meta-yocto-bsp \
  /mnt/ssd2/poky/meta-openembedded/meta-oe \
  /mnt/ssd2/poky/meta-xilinx/meta-xilinx-bsp \
  /mnt/ssd2/poky/meta-zybo-z7 \
  "
```
...
#
SSTATE_DIR ?= "/mnt/ssd2/.sstate-cache"
...
```
machine_name=zybo-z7-zynq7
kernel_image=uImage
kernel_load_address=0x2080000
devicetree_image=zynq-zybo-z7.dtb
...
```
tar x -C /media/$USER/root -f core-image-minimal-zybo-z7-zynq7.tar.gz
```
